...
#define  BOARD_HEIGHT  100.0f	//板子的高度
#define  BOARD_WIDTH   50.0f	//板子的宽度
...
bit startSystem(void)
{
	...
	open_StepMotor(STEP_MOTOR_2);
	g_MotionSystemInfo.systemState = RUNNING;
